...
public class StateGui implements ActionListener {
 ...
 JTable appointmentTable = new JTable(new StateTableModel());
      //  new StateTableModel((Appointment()editor.getAppointments().toArray(new Appointment[1])))
...
break;
case 3: value = data [row] .getStartDate ();//3
break;
...
case 1:
break;
case 2: data[row].setLocation(new Locationlmpl((String)value));
editor .edit ();
break;
case 3:
break;
