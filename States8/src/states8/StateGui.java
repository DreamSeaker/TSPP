...
public class StateGui implements ActionListener {
    ...
    public void createGui() {
        ...
        StateTableModel test = new StateTableModel((Appointment[]) editor.getAppointments().toArray(new Appointment[2]));
        JTable appointmentTable = new JTable(test);
        ...
        public void setValueAt(Object value, int row, int column) {
            switch (column) {
                ...
                case 1:
                    break;
                case 2:
                    data[row].setLocation(new Locationlmpl((String) value));
                    editor.edit();
                    break;
                case 3:
                    break;
