...
public class ContactEditView extends JPanel implements ContactView {
 ...
 private static final String CONT_FIRST_NAME ="First Name:";
 private static final String CONT_LAST_NAME = "Last Name: ";
 private static final String CONT_TITLE = "Title: ";
 private static final String CONT_ORG = "Organization: ";
 ...
 public void createGui() {
   ...
   firstNameLabel = new JLabel(CONT_FIRST_NAME);
   lastNameLabel = new JLabel(CONT_LAST_NAME);
   titleLabel = new JLabel(CONT_TITLE);
   organizationLabel = new JLabel(CONT_ORG);
